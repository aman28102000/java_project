...
public class  VirtualKeyRepo{
		...
		public static void main(String[] args) throws IOException {
			...
			System.out.println("\t`````````````");
			System.out.println(" Developer\t: Aman kumar \n Company\t: XYZcmpy \n");
			...
			public static void listFiles() {
				...
				File directoryPath = new File("D:\\java fsd1\\javademos\\demo");
			...
			public static void deleteFile(String fileToBeDeleted) {
				...
				File file = new File( ("D:\\\\java fsd1\\\\javademos\\\\demo") + "\\" + fileToBeDeleted );
			...
			public static void searchFile(String fileToBeSearched) {
				...
				File file = new File( ("D:\\\\java fsd1\\\\javademos\\\\demo")+"\\"+ fileToBeSearched);
			...
			public static void createFile (String fileToBeCreated) {
				File file = new File(("D:\\\\java fsd1\\\\javademos\\\\demo")  + "\\" + fileToBeCreated );
